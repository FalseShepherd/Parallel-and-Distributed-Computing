...
public class Job1 extends Configured implements Tool {
  ...
  @Override
    ...
    Job job = Job.getInstance(getConf(), "Job1Job");
    job.setJarByClass(Job1.class);  // Main class for MapReduce
    ...
    job.setMapperClass(Job1Mapper.class);  // class to use for Map
    job.setReducerClass(Job1Reducer.class); // class to use for Reduce
