...
public class Job2 extends Configured implements Tool {
  ...
  @Override
    ...
    Job job = Job.getInstance(getConf(), "Job2Job");
    job.setJarByClass(Job2.class);  // Main class for MapReduce
    ...
    job.setMapperClass(Job2Mapper.class);  // class to use for Map
    job.setReducerClass(Job2Reducer.class); // class to use for Reduce
